...
class MXHXParserTagTest extends Test {
	...
	public function testParserWithOpenAndCloseTag():Void {
		...
		Assert.equals(7, unit0.endColumn);
		...
		Assert.equals(0, unit1.line);
		Assert.equals(7, unit1.column);
		Assert.equals(0, unit1.endLine);
		Assert.equals(15, unit1.endColumn);
	...
	public function testParserWithOpenAndCloseTagUnclosedOpenTag():Void {
		...
		Assert.equals(0, unit0.column);
		Assert.equals(0, unit0.endLine);
		Assert.equals(6, unit0.endColumn);
		Assert.isOfType(unit0, IMXHXTagData);
		var tagData0 = cast(unit0, IMXHXTagData);
		Assert.equals(mxhxData.rootTag, tagData0);
		Assert.equals("p:Tag", tagData0.name);
		...
		Assert.equals(0, unit1.line);
		Assert.equals(6, unit1.column);
		Assert.equals(0, unit1.endLine);
		Assert.equals(14, unit1.endColumn);
		Assert.isOfType(unit1, IMXHXTagData);
		var tagData1 = cast(unit1, IMXHXTagData);
		Assert.equals("p:Tag", tagData1.name);
		Assert.equals("Tag", tagData1.shortName);
	...
	public function testParserWithOpenAndCloseTagUnclosedCloseTagWithSelfClosingTagAfter():Void {
		...
		Assert.equals(0, unit0.column);
		Assert.equals(0, unit0.endLine);
		Assert.equals(9, unit0.endColumn);
		Assert.isOfType(unit0, IMXHXTagData);
		var tagData0 = cast(unit0, IMXHXTagData);
		...
		Assert.equals(0, unit1.line);
		Assert.equals(9, unit1.column);
		Assert.equals(0, unit1.endLine);
		Assert.equals(16, unit1.endColumn);
		Assert.isOfType(unit1, IMXHXTagData);
		var tagData1 = cast(unit1, IMXHXTagData);
		Assert.equals("p:Tag", tagData1.name);
		Assert.equals("Tag", tagData1.shortName);
		...
		Assert.equals(0, unit2.line);
		Assert.equals(16, unit2.column);
		Assert.equals(0, unit2.endLine);
		Assert.equals(23, unit2.endColumn);
		...
		Assert.equals(0, unit3.line);
		Assert.equals(23, unit3.column);
		Assert.equals(0, unit3.endLine);
		Assert.equals(33, unit3.endColumn);
		...
		Assert.equals(0, unit4.line);
		Assert.equals(33, unit4.column);
		Assert.equals(0, unit4.endLine);
		Assert.equals(43, unit4.endColumn);
	...
	public function testParserWithOuterOpenAndCloseTagAndInnerOpenTagOnly():Void {
		...
		// TODO: should these be something other than -1
		Assert.equals(-1, unit2.line);
		Assert.equals(-1, unit2.column);
		Assert.equals(-1, unit2.endLine);
		Assert.equals(-1, unit2.endColumn);
		Assert.isOfType(unit2, IMXHXTagData);
		var tagData2 = cast(unit2, IMXHXTagData);
		Assert.equals("p:Tag", tagData2.name);
		Assert.equals("Tag", tagData2.shortName);
		...
		Assert.equals(0, unit3.line);
		Assert.equals(16, unit3.column);
		Assert.equals(0, unit3.endLine);
		Assert.equals(26, unit3.endColumn);
		Assert.isOfType(unit3, IMXHXTagData);
		var tagData3 = cast(unit3, IMXHXTagData);
	...
	public function testParserWithNestedOpenAndClosedTagButOuterOpenTagOnly():Void {
		...
		Assert.equals(16, unit2.column);
		Assert.equals(0, unit2.endLine);
		Assert.equals(24, unit2.endColumn);
		Assert.isOfType(unit2, IMXHXTagData);
		var tagData2 = cast(unit2, IMXHXTagData);
		Assert.equals("p:Tag", tagData2.name);
		Assert.equals("Tag", tagData2.shortName);
